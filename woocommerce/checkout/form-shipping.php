			...
			<div class="col-inner-hori">
				<div class="default align-left lb-1">
					<p id="ship-to-different-address">
						<label for="ship-to-different-address-checkbox" class="checkbox"><?php _e( 'Tick to enter alternative delivery address.', 'woocommerce' ); ?></label>
	...
	<?php if ( apply_filters( 'woocommerce_enable_order_notes_field', get_option( 'woocommerce_enable_order_comments', 'yes' ) === 'yes' ) ) : ?>
		...
		<div class="item col col-50 push-50 left">
			<div class="col-inner-hori">
				<div class="large align-left lb-1">
					<div class="text-item">
						<p><?php _e( 'Additional Information', 'woocommerce' ); ?></p>
					</div>
				</div>
			</div>
		</div>
