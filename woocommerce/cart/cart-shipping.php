...
<div class="shipping">
	<div class="item col-50 push-0 left">
		<div class=""><?php echo wp_kses_post( $package_name ); ?></div>
	</div>
	<div class="item col-50 push-0 left">
		<div class="" style="margin-bottom: 13.5px;">
		...
		<?php elseif ( ! WC()->customer->has_calculated_shipping() ) : ?>
			<p style="text-indent: 0;">Shipping costs will be calculated once you have provided your address</p>
		<?php else : ?>
