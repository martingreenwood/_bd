		...
		<div class="item col col-<?php echo $width ?> push-<?php echo $push ?> <?php echo $float ?> <?php if ($clear == true) { echo 'clear';} ?>">
		  <div class="col-inner-hori" <?php if ($override_grid_gutter) {echo 'style="margin-left: '.$override_grid_gutter.'px !important; margin-right: '.$override_grid_gutter.'px !important;"';} ?>>
			...
			elseif(get_row_layout() == "social_icons"): 
			  ...
			  echo '<div class="share_buttons '.$text_size.' '.$line_break.'">';
			  if ($share_buttons) {
				echo '<div class="text-item">';
				  echo '<a target="_blank" class="fb" href="http://www.facebook.com/sharer/sharer.php?u='. get_permalink().'&title='. get_the_title().'"><i class="fa fa-facebook"></i></a>';
				  echo '<a target="_blank" class="tw" href="http://twitter.com/intent/tweet?status='.get_the_title().'+'.get_permalink().'"><i class="fa fa-twitter"></i></a>';
				  echo '<a target="_blank" class="em" href="mailto:?subject='.get_the_title().'&body=Check this out - '.get_permalink().'"><i class="fa fa-envelope-o"></i></a>';
				  echo '<a target="_blank" class="pn" href="http://pinterest.com/pin/create/bookmarklet/?&url='.get_permalink().'&is_video=false&description='.get_the_title().'"><i class="fa fa-pinterest-p"></i></a>';
				  echo '<a target="_blank" class="gp" href="https://plus.google.com/share?url='.get_permalink().'"><i class="fa fa-google"></i></a>';
				echo '</div>';
			  }
			  echo '</div>'; 
